...
private:
    ...
    int adjMatrix[10][10];       //Matriks Ketetanggaan (Arah Graf)
...
public:
    ...
    void tambahDependensi(int indeksBahan, int indeksHasil) {
        adjMatrix[indeksBahan][indeksHasil] = 1;
        inDegree[indeksHasil]++; // Tambah jumlah prasyarat item hasil
    }

    //Method utama Topological Sorting (Algoritma Kahn)
